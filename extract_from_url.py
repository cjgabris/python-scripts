...
def map_to_kml():
	mxd = arcpy.mapping.MapDocument(WDCEP)
	df = arcpy.mapping.ListDataFrames(mxd)[0]
	arcpy.MapToKML_conversion(WDCEP, "Layers", "map_to_kml2.kmz","0","NO_COMPOSITE","VECTOR_TO_IMAGE","DEFAULT","1024","96","CLAMPED_TO_GROUND")
